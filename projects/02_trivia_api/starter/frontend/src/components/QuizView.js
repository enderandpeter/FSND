...
class QuizView extends Component {
    ...
    evaluateAnswer = () => {
        ...
        formatGuess = formatGuess.trim()
        const formatGuessArray = formatGuess.split(' ');
        const answerArray = this.state.currentQuestion.answer.toLowerCase().split(' ');
        return formatGuessArray.every((guessWord) => answerArray.includes(guessWord));
    }
    ...
    renderCorrectAnswer() {
        ...
        return (
            <div className="quiz-play-holder">
                ...
                <div className="next-question button" autoFocus={true} onClick={this.getNextQuestion}> Next Question
                </div>
            </div>
        )
    }
